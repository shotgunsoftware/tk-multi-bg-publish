...
$UI_PYTHON_PATH="../python/tk_multi_bgpublish/ui"

# the paths to where the PySide binaries are installed
$PYTHON_EXE="B:/Softwares/Autodesk/Shotgun-1.5.9/Python/python.exe"
$PYTHON_UIC="B:/Softwares/Autodesk/Shotgun-1.5.9/Python/Lib/site-packages/PySide/scripts/uic.py"
